  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, rgba(124,58,237,0.2), rgba(6,182,212,0.1), rgba(236,72,153,0.15))',
      ...
      boxShadow: {
        ...
        'card-hover': '0 20px 60px rgba(0,0,0,0.5), 0 0 40px rgba(124,58,237,0.15)',
