    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#f0f0f5] py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-[#a0a0b8]">No subscriptions. No hidden fees. Just a fair marketplace.</p>
        </div>
        ...
        <div className="relative py-12 mb-20 max-w-lg mx-auto">
          ...
          <div className="relative z-10 space-y-12">
            <div className="flex flex-col items-center bg-[#0a0a0f] py-4">
              <div className="w-16 h-16 rounded-full bg-[#13131a] border border-purple-500/30 flex items-center justify-center mb-4 shadow-[0_0_30px_rgba(124,58,237,0.2)]">
            ...
            <div className="flex flex-col items-center bg-[#0a0a0f] py-4">
              <div className="w-16 h-16 rounded-full bg-[#13131a] border border-cyan-500/30 flex items-center justify-center mb-4">
            ...
            <div className="flex flex-col items-center bg-[#0a0a0f] py-4">
              <div className="w-16 h-16 rounded-full bg-[#13131a] border border-pink-500/30 flex items-center justify-center mb-4">
            ...
            <div className="flex flex-col items-center bg-[#0a0a0f] py-4">
              <div className="w-16 h-16 rounded-full bg-[#13131a] border border-green-500/30 flex items-center justify-center mb-4 shadow-[0_0_30px_rgba(34,197,94,0.2)]">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-8 max-w-lg mx-auto mb-20 relative overflow-hidden">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex justify-between items-center text-[#a0a0b8]">
