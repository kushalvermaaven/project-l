  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-[#f0f0f5]">
      ...
      <section className="py-24 px-6 text-center max-w-4xl mx-auto">
        ...
        <p className="text-xl text-[#a0a0b8] leading-relaxed">
      ...
      <section className="py-24 px-6 bg-[#13131a]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2 relative">
            ...
            <div className="bg-[#1a1a2e] border border-white/10 p-8 rounded-3xl relative z-10 backdrop-blur-sm">
          ...
          <div className="md:w-1/2 space-y-8">
            <div className="bg-white/5 border border-white/10 p-8 rounded-2xl">
              ...
              <p className="text-[#a0a0b8]">To empower independent artists globally by providing them with the tools, platform, and audience to build sustainable careers, while helping art lovers discover pieces that truly resonate with them.</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-2xl">
              <Eye className="w-10 h-10 text-cyan-400 mb-4" />
              <h3 className="text-2xl font-heading font-bold mb-3">Our Vision</h3>
              <p className="text-[#a0a0b8]">A world where every wall tells a unique story, where mass-produced décor is replaced by original creations, and where being an independent artist is a thriving profession.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-[#13131a] p-8 rounded-2xl border border-white/5 text-center">
              ...
              <p className="text-[#a0a0b8] text-sm">{val.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-purple-900/20 to-cyan-900/20 border-y border-white/10">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            ...
            <div className="text-[#a0a0b8] uppercase tracking-wider text-sm">Artworks</div>
          </div>
          <div>
            <div className="text-4xl md:text-5xl font-bold text-white mb-2">2K+</div>
            <div className="text-[#a0a0b8] uppercase tracking-wider text-sm">Artists</div>
          </div>
          <div>
            <div className="text-4xl md:text-5xl font-bold text-white mb-2">50K+</div>
            <div className="text-[#a0a0b8] uppercase tracking-wider text-sm">Customers</div>
          </div>
          <div>
            <div className="text-4xl md:text-5xl font-bold text-white mb-2">100+</div>
            <div className="text-[#a0a0b8] uppercase tracking-wider text-sm">Categories</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <p className="text-xl text-[#a0a0b8] mb-10 max-w-2xl mx-auto">Be part of a growing ecosystem of creators and art enthusiasts.</p>
